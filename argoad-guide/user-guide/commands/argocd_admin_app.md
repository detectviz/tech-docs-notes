...
# 比較兩個協調的結果並列印差異
argocd admin app diff-reconcile-results APPNAME [旗標]
...
* [argocd admin app diff-reconcile-results](argocd_admin_app_diff-reconcile-results.md)	 - 比較兩個協調的結果並列印差異。
* [argocd admin app generate-spec](argocd_admin_app_generate-spec.md)	 - 為應用程式產生宣告式組態
* [argocd admin app get-reconcile-results](argocd_admin_app_get-reconcile-results.md)	 - 協調所有應用程式並將協調摘要儲存在指定的檔案中。
