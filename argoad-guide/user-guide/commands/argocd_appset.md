...
```
  ...
  # 列出所有的 ApplicationSets
  argocd appset list
  
  # 從儲存在檔案中或給定 URL 的 YAML 建立 ApplicationSet
...
* [argocd appset create](argocd_appset_create.md)	 - 建立一或多個 ApplicationSets
* [argocd appset delete](argocd_appset_delete.md)	 - 刪除一或多個 ApplicationSets
* [argocd appset generate](argocd_appset_generate.md)	 - 產生 ApplicationSet 呈現範本的應用程式
* [argocd appset get](argocd_appset_get.md)	 - 取得 ApplicationSet 詳細資訊
* [argocd appset list](argocd_appset_list.md)	 - 列出 ApplicationSets
