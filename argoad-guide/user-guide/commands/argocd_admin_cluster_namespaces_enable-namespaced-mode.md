# `argocd admin cluster namespaces enable-namespaced-mode` 命令參考

## argocd admin cluster namespaces enable-namespaced-mode

為名稱符合指定模式的叢集啟用命名空間模式。
