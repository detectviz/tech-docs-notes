# `argocd admin settings resource-overrides ignore-differences` 命令參考
...
使用 'argocd-cm' ConfigMap 中 'resource.customizations' 欄位指定的 'ignoreDifferences' 設定來呈現忽略的欄位
