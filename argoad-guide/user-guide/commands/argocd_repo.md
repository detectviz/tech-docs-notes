...
* [argocd repo add](argocd_repo_add.md)	 - 新增 git、oci 或 helm 儲存庫連線參數
* [argocd repo get](argocd_repo_get.md)	 - 透過 URL 取得已設定的儲存庫
* [argocd repo list](argocd_repo_list.md)	 - 列出已設定的儲存庫
* [argocd repo rm](argocd_repo_rm.md)	 - 移除已設定的儲存庫
