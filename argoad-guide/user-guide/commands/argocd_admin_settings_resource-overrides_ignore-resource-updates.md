# `argocd admin settings resource-overrides ignore-resource-updates` 命令參考
...
使用 'argocd-cm' ConfigMap 中 'resource.customizations' 欄位指定的 'ignoreResourceUpdates' 設定來呈現忽略的欄位
...
```
  -h, --help                                              ignore-resource-updates 的說明
