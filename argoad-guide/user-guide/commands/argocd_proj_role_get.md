...
1696774900  2023-10-08T15:21:40+01:00 (4 分鐘前)  <none>
1696759698  2023-10-08T11:08:18+01:00 (4 小時前)    <none>
...
```
  ...
  -H, --header 字串陣列                  為 Argo CD CLI 發出的所有請求設定額外的標頭。(可以重複多次以新增多個標頭, 也支援以逗號分隔的標頭)
      ...
      --server-name 字串              Argo CD API 伺вер器的名稱；當伺服器的名稱標籤與預設值不同時，設定此選項或 ARGOCD_SERVER_NAME 環境變數，例如透過 Helm 圖表安裝時 (預設為 "argocd-server")
```
