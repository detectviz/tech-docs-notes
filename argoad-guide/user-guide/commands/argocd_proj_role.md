...
* [argocd proj role add-group](argocd_proj_role_add-group.md)	 - 將群組宣告新增至專案角色
* [argocd proj role add-policy](argocd_proj_role_add-policy.md)	 - 將策略新增至專案角色
* [argocd proj role create](argocd_proj_role_create.md)	 - 建立專案角色
* [argocd proj role create-token](argocd_proj_role_create-token.md)	 - 建立專案權杖
* [argocd proj role delete](argocd_proj_role_delete.md)	 - 刪除專案角色
* [argocd proj role delete-token](argocd_proj_role_delete-token.md)	 - 刪除專案權杖
* [argocd proj role get](argocd_proj_role_get.md)	 - 取得特定角色的詳細資料
* [argocd proj role list](argocd_proj_role_list.md)	 - 列出專案中的所有角色
* [argocd proj role list-tokens](argocd_proj_role_list-tokens.md)	 - 列出給定角色的權杖。
* [argocd proj role remove-group](argocd_proj_role_remove-group.md)	 - 從專案中的角色移除群組宣告
* [argocd proj role remove-policy](argocd_proj_role_remove-policy.md)	 - 從專案中的角色移除策略
