...
* [argocd appset](argocd_appset.md)	 - 管理 ApplicationSets
* [argocd cert](argocd_cert.md)	 - 管理儲存庫憑證和 SSH 已知主機項目
* [argocd cluster](argocd_cluster.md)	 - 管理叢集憑證
* [argocd completion](argocd_completion.md)	 - 為指定的 shell (bash, zsh 或 fish) 輸出 shell 自動完成程式碼
* [argocd configure](argocd_configure.md)	 - 管理本機組態
* [argocd context](argocd_context.md)	 - 在上下文之間切換
* [argocd gpg](argocd_gpg.md)	 - 管理用於簽章驗證的 GPG 金鑰
* [argocd login](argocd_login.md)	 - 登入 Argo CD
* [argocd logout](argocd_logout.md)	 - 登出 Argo CD
* [argocd proj](argocd_proj.md)	 - 管理專案
* [argocd relogin](argocd_relogin.md)	 - 重新整理過期的驗證權杖
* [argocd repo](argocd_repo.md)	 - 管理儲存庫連線參數
* [argocd repocreds](argocd_repocreds.md)	 - 管理儲存庫的憑證範本
* [argocd version](argocd_version.md)	 - 列印版本資訊
