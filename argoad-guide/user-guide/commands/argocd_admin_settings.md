...
* [argocd admin](argocd_admin.md)	 - 包含一組對 Argo CD 管理員有用的指令，並需要直接存取 Kubernetes
* [argocd admin settings rbac](argocd_admin_settings_rbac.md)	 - 驗證和測試 RBAC 設定
* [argocd admin settings resource-overrides](argocd_admin_settings_resource-overrides.md)	 - 資源覆寫疑難排解
* [argocd admin settings validate](argocd_admin_settings_validate.md)	 - 驗證設定
