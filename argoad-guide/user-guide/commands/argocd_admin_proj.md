...
* [argocd admin proj generate-allow-list](argocd_admin_proj_generate-allow-list.md)	 - 從指定的 clusterRole 檔案產生專案允許清單
* [argocd admin proj generate-spec](argocd_admin_proj_generate-spec.md)	 - 為專案產生宣告式設定
* [argocd admin proj update-role-policy](argocd_admin_proj_update-role-policy.md)	 - 實作大量專案角色更新。有助於回填現有的專案策略或移除過時的操作。
