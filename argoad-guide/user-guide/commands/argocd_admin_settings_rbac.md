# `argocd admin settings rbac` 命令參考
...
* [argocd admin settings rbac can](argocd_admin_settings_rbac_can.md)	 - 檢查角色或主體的 RBAC 權限
* [argocd admin settings rbac validate](argocd_admin_settings_rbac_validate.md)	 - 驗證 RBAC 策略
