# `argocd proj windows delete` 命令參考

## argocd proj windows delete

從專案中刪除同步視窗。需要提供 ID，可以透過執行 "argocd proj windows list PROJECT" 找到。
...
# 從專案 (default) 中刪除 ID 為 0 的同步視窗
argocd proj windows delete default 0

# 從專案 (new-project) 中刪除 ID 為 1 的同步視窗
