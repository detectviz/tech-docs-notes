# `argocd admin notifications trigger` 命令參考
...
* [argocd admin notifications](argocd_admin_notifications.md)	 - 有助於管理通知設定的 CLI 指令集
* [argocd admin notifications trigger get](argocd_admin_notifications_trigger_get.md)	 - 列印有關已設定觸發器的資訊
* [argocd admin notifications trigger run](argocd_admin_notifications_trigger_run.md)	 - 評估指定的觸發器條件並列印結果
