# `argocd admin cluster namespaces` 命令參考
...
```
argocd admin cluster namespaces [旗標]
```
...
* [argocd admin cluster namespaces disable-namespaced-mode](argocd_admin_cluster_namespaces_disable-namespaced-mode.md)	 - 為名稱符合指定模式的叢集停用命名空間模式。
* [argocd admin cluster namespaces enable-namespaced-mode](argocd_admin_cluster_namespaces_enable-namespaced-mode.md)	 - 為名稱符合指定模式的叢集啟用命名空間模式。
