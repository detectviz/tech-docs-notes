...
* [argocd app actions list](argocd_app_actions_list.md)	 - 列出資源上可用的操作
* [argocd app actions run](argocd_app_actions_run.md)	 - 在符合指定篩選條件的資源上執行可用的操作。
