# `argocd admin settings resource-overrides list-actions` 命令參考
...
使用 'argocd-cm' ConfigMap 中 'resource.customizations' 欄位設定的 lua 指令碼，列出給定資源操作可用的操作，並輸出更新的欄位
